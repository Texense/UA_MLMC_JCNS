...
function [rates_drop,RelaDiff,Syn] = RingNetwork_couple(T,ss1,ss2,dt1,dt2,T_sam)
%T = 5000*10;
...
[~,spike1,t1,~,~,Syn1] = ...
    MC_Vseries_for_network_ninput_I_based_norms_Syn(dt1,T,V_0s,eventsN,fs,S,ss1*S1amp,ss2*S2amp,ss2*S2amp,ss1*S1amp,NE,NI);

[~,spike2,t2,~,~,Syn2] = ...
    MC_Vseries_for_network_ninput_I_based_norms_Syn(dt2,T,V_0s,eventsN,fs,S,ss1*S1amp,ss2*S2amp,ss2*S2amp,ss1*S1amp,NE,NI);
